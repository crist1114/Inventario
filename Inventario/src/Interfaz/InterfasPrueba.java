...
public class InterfasPrueba extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==menuItem2){
            setSize(840,640);
            scroll.setBounds(0,0,900,800);
            setLocationRelativeTo(null);
        }
        if(e.getSource()==menuItem3){
            setSize(10240,840);
            scroll.setBounds(0,0,1400,1000);
            setLocationRelativeTo(null);
        }
        ...
        if(e.getSource()==menuAbrir){
            ...
            scroll= new JScrollPane(textArea);
            scroll.setBounds(10,5,1200,1000);
            add(scroll);
        }
